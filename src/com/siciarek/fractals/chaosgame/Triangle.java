package com.siciarek.fractals.chaosgame;

import com.siciarek.fractals.SierpinskiTriangle;
import com.siciarek.fractals.common.Drawable;
import com.siciarek.fractals.common.Utils;

import java.util.*;

public class Triangle extends SierpinskiTriangle {
	...
	public Triangle(Drawable canvas) {
		super(canvas, true);
